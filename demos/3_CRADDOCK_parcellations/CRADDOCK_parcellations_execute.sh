...
cd /mnt/storage/neuronumba/demos/3_CRADDOCK_parcellations

# parcellations to loop through
parcellations=("038-${parcellation_name}" "056-${parcellation_name}" "108-${parcellation_name}" "160-${parcellation_name}") 

BASE_DIR="/mnt/storage/neuronumba/demos/3_CRADDOCK_parcellations"
